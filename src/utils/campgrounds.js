export const campgrounds = [
  {
    ...
    comments: [
      ...
      },
      {
        ...
        user: "Issac Dylan",
        comment:
          "Traveling changes you as a person, you gain more persective this is the perfect spot to do that.",
      },
    ],
  },

  {
    ...
    image: "/CampImages/CompressedImages/CalaguasIsland.jpg",
    Highimage: "/CampImages/HighQualityImages/CalaguasIsland.jpg",
    comments: [],
    user: "Andrew Mike",
  },

  {
    ...
    Highimage: "/CampImages/HighQualityImages/OnayBeach.jpg",
    comments: [],
    user: "Andrew Mike",
  },
  {
    ...
    Highimage: "/CampImages/HighQualityImages/SevenSistersWaterfall.jpg",
    comments: [],
    user: "Andrew Mike",
  },
  {
    ...
    Highimage: "/CampImages/HighQualityImages/LatikRiverside.jpg",
    comments: [],
    user: "Andrew Mike",
  },
  {
    ...
    Highimage: "/CampImages/HighQualityImages/BuloySprings.jpg",
    comments: [],
    user: "Andrew Mike",
  },
];
